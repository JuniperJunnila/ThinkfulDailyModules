...
*/
var ratings = document.querySelectorAll(".rating .value");
console.log(ratings);
/**
...
var established = document.querySelector('#ganp .stats .established .value');
...
if (ratings) {
  if (ratings instanceof NodeList) {
    ratings.forEach(function (node) {
      return node.classList.add("r1");
    });
  } else {
...
if (halfStars) {
  if (halfStars instanceof NodeList) {
    halfStars.forEach(function (node) {
      return node.classList.add("h1");
    });
  } else {
